...
class PostController extends Controller
{
  ...
  public function BlogCatStore(Request $request)
  {
    $validateDate = $request->validate([
      ...
      'category_name_ir' => 'required|max:255',

    ]);

    $data = array();
    $data['category_name_en'] = $request->category_name_en;
    $data['category_name_ir'] = $request->category_name_ir;
  ...
  public function store(Request $request)
  {
    ...
    $data['post_title_ir'] = $request->post_title_ir;
    $data['category_id'] = $request->category_id;
    $data['details_en'] = $request->details_en;
    $data['details_ir'] = $request->details_ir;
    ...
    if ($post_image) {
      ...
      $post_image->move($upload_path, $post_image_name);
