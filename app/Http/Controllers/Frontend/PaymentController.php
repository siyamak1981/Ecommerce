...
class PaymentController extends Controller
{
    ...
    public function StripeCharge(Request $request)
    {
        ...
        \Stripe\Stripe::setApiKey('sk_test_51HtIgEHvRXBiTguBv1LrYbCq5FMAlx9zE4M9ja8zeqgXxKoXOl10zVPzd32OtSldFlaQtXh0YoNJyA9g1vJNkyQF00SBCSn5Kr');
        ...
        $charge = \Stripe\Charge::create([
            'amount' => $total * 100,
            'currency' => 'usd',
            'description' => 'Siyamak Ecommerce Details',
            'source' => $token,
