...
<div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    <a class="breadcrumb-item" href="{{route('product.index')}}">Starlight</a>
      ...
      <form method="post" action="{{ route('product.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-layout">
          <div class="row mg-b-25">
            ...
            <div class="col-lg-12">
              <div class="form-group">
                <label class="form-control-label">Product Details: <span class="tx-danger">*</span>
                </label>
              </div>
              <div class="box-body pad">
                <textarea name="product_details" id="editor"></textarea>
              </div>
            </div>
